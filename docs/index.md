...
2. [Panduan Penggunaan (User Manual)](user-guide.md)
   - Alur operasional Operator Sekolah (SPJ, checklist realisasi, cetak) dan Admin KCD (monitoring & kunci).
...
5. [Alur & Modul Per Role](modules.md)
   - Detail alur Dashboard, Data Barang (Buku SPJ), Target Acuan Kerja Realisasi (`?mode=realisasi`), Cetak 26 Kolom, dan Rekapan.
