...
> sebelum merge. Status: 79 passed / 406 assertions.
...
## 3. Matriks Cakupan (14 Feature + 4 Unit)
...
| `DbErrorHandlingTest` | `QueryException` → redirect + pesan ramah (web) / JSON 500 tanpa SQL bocor, `Log::error` konteks user+route |
