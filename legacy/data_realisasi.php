...
if (isset($_GET['proses_cetak_excel'])) {
    ...
    $sheet->setCellValue('A2', strtoupper(safeExcelVal($nama_sekolah_user)));
    $sheet->mergeCells('A2:Y2');
    $sheet->setCellValue('A3', 'PERIODE TAHUN '.($filter_tahun > 0 ? $filter_tahun : '2026'));
    $sheet->mergeCells('A3:Y3');

    $styleJudul = ['font' => ['bold' => true, 'color' => ['rgb' => '000000'], 'size' => 11, 'name' => 'Calibri'], 'alignment' => ['horizontal' => Alignment::HORIZONTAL_CENTER, 'vertical' => Alignment::VERTICAL_CENTER]];
    ...
    $styleHeaderTable = ['fill' => ['fillType' => Fill::FILL_SOLID, 'startColor' => ['rgb' => 'DDEBF7']], 'font' => ['bold' => false, 'size' => 11, 'name' => 'Calibri'], 'alignment' => ['horizontal' => Alignment::HORIZONTAL_CENTER, 'vertical' => Alignment::VERTICAL_CENTER, 'wrapText' => true], 'borders' => ['allBorders' => ['borderStyle' => Border::BORDER_THIN, 'color' => ['rgb' => '000000']]]];
    ...
    if ($lastDataRow >= 10) {
        ...
        $sheet->getStyle($rangeAll)->getBorders()->getAllBorders()->setBorderStyle(Border::BORDER_THIN)->getColor()->setRGB('000000');
