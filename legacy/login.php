...
if (file_exists('koneksi.php')) {
    ...
    exit("Error: File 'koneksi.php' tidak ditemukan. Pastikan file tersebut ada di folder yang sama.");
}
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (! isset($_POST['csrf_token']) || ! hash_equals($_SESSION['csrf_token'], $_POST['csrf_token'])) {
        ...
        exit('Akses ditolak: Token keamanan (CSRF) tidak valid atau sesi telah kedaluwarsa. Silakan refresh halaman.');
    }
